...
1. Are static graphics (e.g. PDFs) "good enough"?

<img src="images/philosoraptor.jpeg" style="width: 50%; display: block; margin: auto;">

<p style="font-size: 10pt">image from [http://cheezburger.com](http://cheezburger.com)</p>

## Let's make it interactive! {.build}

1. Are static graphics (e.g. PDFs) "good enough"?

> 2. What step in the analysis does it come in? For me:
      - exploratory - looking at where image outcomes occur
      - confirmatory - see how model predicts image outcome
> 3. 


## But other programs can do this!

<img src="images/stacked.gif" style="width: 100%; display: block; margin: auto;">
...
## Secon Attempt: Set of PDFs or one GIFs!
...
# if (!file.exists(outname)) {
    ...
    png_converter(
      paste0(tstub, "*.png"),
      extra.opts = "-delay 80 -density 300",
      outname)
# }
```
